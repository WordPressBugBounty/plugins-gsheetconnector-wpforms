...
class WPforms_Gsheet_Connector_Init
{
   ...
   {
      wp_add_dashboard_widget('wpform_gs_dashboard', __("<img style='width:30px;margin-right: 10px;' src='" . WPFORMS_GOOGLESHEET_URL . "assets/img/wpforms-gsc.png'><span>WPForms - GSheetConnector</span>", 'gsheetconnector-wpforms'), array($this, 'wpform_gs_connector_summary_dashboard'));
   }
