...
<div class="system-statuswc">
   <div class="info-container">
    <h2 class="systemifo"><?php echo esc_html__('System Info', 'gsheetconnector-wpforms'); ?></h2>
      <button onclick="copySystemInfo()" class="copy"><?php echo esc_html__('Copy System Info to Clipboard', 'gsheetconnector-wpforms'); ?></button>
      <?php echo $WpForms_gs_tools_service->get_wpforms_system_info(); ?>
   </div>
</div>
<div class="system-Error">
    <div class="error-container">
        <h2 class="systemerror"><?php echo esc_html__('Error Log', 'gsheetconnector-wpforms'); ?></h2>
        <p><?php echo esc_html__('If you have', 'gsheetconnector-wpforms'); ?> <a href="https://www.gsheetconnector.com/how-to-enable-debugging-in-wordpress" target="_blank"><?php echo esc_html__('WP_DEBUG_LOG', 'gsheetconnector-wpforms'); ?></a> <?php echo esc_html__('enabled, errors are stored in a log file. Here you can find the last 100 lines in reversed order so that you or the GSheetConnector support team can view it easily. The file cannot be edited here.', 'gsheetconnector-wpforms'); ?></p>
        <button onclick="copyErrorLog()" class="copy"><?php echo esc_html__('Copy Error Log to Clipboard', 'gsheetconnector-wpforms'); ?></button>
         <button class="clear-content-logs-wp"><?php echo esc_html__('Clear', 'gsheetconnector-wpforms'); ?></button>
        ...
        <div class="copy-message" style="display: none;"><?php echo esc_html__('Copied', 'gsheetconnector-wpforms'); ?></div> <!-- Add a hidden div for the copy message -->
