    ...
    <div class="wpform_pro_demo">
        <div class="cd-faq-content" style="display: block;">
            <div class="gs-demo-fields gs-second-block">
                ...
                <h2 class="upgradetoprotitlewpform"><?php echo esc_html(__('Upgrade to WPForms Google sheet Connector PRO', 'gsheetconnector-wpforms')); ?></h2>
                <hr class="divide">
                <p>
                ...
                <a href="https://www.gsheetconnector.com/wpforms-google-sheet-connector-pro?gsheetconnector-ref=17"
                    target="_blank">
                    <h3><?php echo esc_html(__('WPForms Google Sheet Connector PRO Features', 'gsheetconnector-wpforms')); ?> </h3>
                </a>
                <div class="gsh_wpform_pro_fatur_int1">
                    <ul style="list-style: square;margin-left:30px">
                        <li><?php echo esc_html(__('Google Sheets API (Up-to date)', 'gsheetconnector-wpforms')); ?></li>
                        ...
                        <li><?php echo esc_html(__('Automated Sheet Name & Tab Name', 'gsheetconnector-wpforms')); ?></li>
                        <li><?php echo esc_html(__('Manually Adding Sheet Name & Tab Name', 'gsheetconnector-wpforms')); ?></li>
                        <li><?php echo esc_html(__('Supported WPForms Lite/Pro', 'gsheetconnector-wpforms')); ?></li>
                        <li><?php echo esc_html(__('Latest WordPress & PHP Support', 'gsheetconnector-wpforms')); ?></li>
...
<div class="card-wpforms dropdownoption-wpforms">
    <div class="lbl-drop-down-select">
        <label for="gs_wpforms_dro_option"><?php echo esc_html__('Choose Google API Setting :', 'gsheetconnector-wpforms'); ?></label>
    </div>
    <div class="drop-down-select-btn">
        <select id="gs_wpforms_dro_option" name="gs_wpforms_dro_option">
            <option value="wpforms_existing" selected><?php echo esc_html__('Use Existing Client/Secret Key (Auto Google API Configuration)', 'gsheetconnector-wpforms'); ?>
            </option>
            ...
            <div id="wp-gsc-cta" class="wp-gsc-privacy-box">
                <div class="wp-gsc-table">
                    <div class="wp-gsc-less-free">
						<p><i class="dashicons dashicons-lock"></i><?php echo esc_html__(' We do not store any of the data from your Google account on our servers, everything is processed & stored on your server. We take your privacy extremely seriously and ensure it is never misused.', 'gsheetconnector-wpforms'); ?></p> <a href="https://gsheetconnector.com/usage-tracking/" target="_blank" rel="noopener noreferrer"><?php echo esc_html__('Learn more.', 'gsheetconnector-wpforms'); ?></a>
                    </div>
                </div>
            </div>
        </p>
                ...
                <li>
                    <a href="https://www.gsheetconnector.com/wpforms-google-sheet-connector-pro" target="_blank">
                        <div>
                            ...
                            <p><?php echo esc_html__(' Multiple Forms to Sheets, Custom mail tags and much more...', 'gsheetconnector-wpforms'); ?></p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="https://www.gsheetconnector.com/wpforms-google-sheet-connector-pro" target="_blank">
                        <div>
                            ...
                            <p><?php echo esc_html__('Compatibility with WPForms Third-Party Plugins', 'gsheetconnector-wpforms'); ?></p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="https://www.gsheetconnector.com/wpforms-google-sheet-connector-pro" target="_blank">
                        <div>
                            ...
                            <p><?php echo esc_html__('This plugin supports multi-languages as well!', 'gsheetconnector-wpforms'); ?></p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="https://support.gsheetconnector.com/kb/wpforms-gsheetconnector-introduction" target="_blank">
                        <div>
                            <button class="icon-button">
                                <span class="dashicons dashicons-download"></span>
                            </button>
                ...
                <li>
                    <a href="https://support.gsheetconnector.com/kb/wpforms-gsheetconnector-introduction" target="_blank">
                        ...
                        <div>
                            ...
                            <p><?php echo esc_html__('Understand all the capabilities of WPForms GsheetConnector', 'gsheetconnector-wpforms'); ?></p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="https://www.gsheetconnector.com/support" target="_blank">
                        ...
                        <div>
                            ...
                            <p><?php echo esc_html__('Direct help from our qualified support team', 'gsheetconnector-wpforms'); ?></p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="https://www.gsheetconnector.com/affiliate-area" target="_blank">
                        ...
                        <div>
                            ...
                            <p><?php echo esc_html__('Earn flat 30', 'gsheetconnector-wpforms'); ?>% <?php echo esc_html__('on every sale', 'gsheetconnector-wpforms'); ?>!</p>
                        </div>
                    </a>
                </li>
            </ul>
