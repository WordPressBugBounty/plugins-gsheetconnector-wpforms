...
jQuery(document).ready(function (jQuery) {
    ...
    jQuery(".gscwpfrom-install-plugin-btn-pro").on("click", function () {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                security: jQuery("#gscwpform_ajax_nonce").val(),
            },
    ...
    jQuery(document).on("click", ".gscwpform-activate-plugin-btn-pro", function () {
        var button = jQuery(this);
        var pluginSlug = button.data("plugin");
    ...
    jQuery(".gscwpform-deactivate-plugin-pro").on("click", function () {
